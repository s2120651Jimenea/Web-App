...
<div class="btn-box">
<a class="viewbtn" onclick="document.getElementById('id03').style.display='block'">Change Email</a> 
<a class="viewbtn" onclick="document.getElementById('id02').style.display='block'">Change Password</a> 
...
<form method="POST" action="processes/process.user.php?action=update">
        ...
        <input type="submit" value="Update Profile">
          <?php
            if($user->get_user_status($id) == "1"){
              ?>
                <a class="statusbtn" onclick="document.getElementById('id01').style.display='block'">Disable Account</a>
              <?php
            }else{ 
            ?>
                <a class="statusbtn" onclick="document.getElementById('id01').style.display='block'">Activate Account</a>
            <?php
            }
          ?>
        </div>
        ...
        <?php
         if($user->get_user_status($id) == "1"){  
         ?>
           <button class="confirmbtn-change" onclick="disableSubmit()">Confirm</button>
        <?php }else {?>
           <button class="confirmbtn-change" onclick="enableSubmit()">Confirm</button>
        <?php };?>
